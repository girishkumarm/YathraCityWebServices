$(document).ready(function() {
	...
	var width = $(window).width();
		 ...
		 document.location.replace("http://tabcars.in/mobile/rentCars/orderDetails.html");
		 $('.websiteView').hide();
	     }
	$(document).ready(function() {
...
var getCarAvailability = function() {
    ...
    HTTPUtil.POST(TAB.ENDPOINT+"rest/cars/get-car-details", inputObject, function(res, err) {

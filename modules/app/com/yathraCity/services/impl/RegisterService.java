...
public class RegisterService implements RegisterServiceInterface {
	...
	public RegisterUserResponse registerUser( ServiceExecutionContext ctx, RegisterUser input ) throws ExecException
	{
		...
		try
		{
			...
			// throw new ExecException( ErrorCodes.INVALID_EMAIL_ID, null, "Not
			// a valid Email Id" );
			// }
		...
		{
			logger.error("Error while registration of the user" + m.getMessage());
			throw m;
		}
		catch( Exception e )
		{
			logger.error("Error while registration of the user" + e.getMessage());

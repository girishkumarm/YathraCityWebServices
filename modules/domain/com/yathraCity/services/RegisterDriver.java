...
public class RegisterDriver{
	...
	public com.yathraCity.core.RegisterCarResponse registerdriver(com.yathraCity.core.RegisterCarDetails registerDriver){
		...
		try
		{
			...
			RegisterDriverInterface intfc =  (RegisterDriverInterface) (ServiceParser.getImpl("com.yathraCity.services.RegisterDriver"));
			if (intfc == null) throw new ExecException(ErrorCodes.APPLICATION_ERROR,null,"Service not implemented");
			resp =  intfc.registerdriver(context,registerDriver);
			SessionUtils.clear(request);
			return resp;
